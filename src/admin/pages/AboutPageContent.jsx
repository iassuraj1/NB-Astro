...
import { Loader2, Save, ArrowLeft, Plus, Trash2, Upload } from 'lucide-react';
import { aboutPageAPI } from '../services/api';
import RichTextEditor from '../components/Common/TinyMCEEditor';
import ImageSizeHint from '../components/Common/ImageSizeHint';
...
const AboutPageContent = () => {
 ...
 const handleImageUpload = async (field, file) => {
    ...
    oldImagePath = current[fieldPath[fieldPath.length - 1]] || '';
    
    if (oldImagePath) {
        formData.append('oldImagePath', oldImagePath);
        console.log('🗑️ Sending old image:', oldImagePath);
    }
    
    // Send field name for folder detection
    ...
    try {
        ...
        if (response.ok && data.success) {
            ...
            target[fieldPath[fieldPath.length - 1]] = data.imagePath;
            setContent(newContent);
    ...
    const addExpertiseItem = () => {
        setContent(prev => ({
            ...
            expertise: {
                ...prev.expertise,
                items: [...prev.expertise.items, { text: '' }]
            }
        }));
    };
    ...
    // ✅ STABLE onChange handlers for each editor (useCallback)
    const handleIntroChange = useCallback((value) => {
        setContent(prev => ({
            ...prev,
            introduction: { ...prev.introduction, content: value }
        }));
    }, []);

    const handleTeachingChange = useCallback((value) => {
        setContent(prev => ({
            ...prev,
            teaching: { ...prev.teaching, content: value }
        }));
    }, []);

    const handleConsultationChange = useCallback((value) => {
        setContent(prev => ({
            ...prev,
            consultation: { ...prev.consultation, content: value }
        }));
    }, []);

    const handleBeyondChange = useCallback((value) => {
        setContent(prev => ({
            ...prev,
            beyond: { ...prev.beyond, content: value }
        }));
    }, []);
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-4">
                                        <input
                                            type="text"
                                            value={content.hero.image}
                                            onChange={(e) => setContent(prev => ({ ...prev, hero: { ...prev.hero, image: e.target.value } }))}
                                            className="flex-1 px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                            placeholder="https://example.com/hero-image.jpg"
                                        />
                                        <label className="px-4 py-2 bg-[#00B7B3]/20 text-[#00B7B3] rounded-lg cursor-pointer hover:bg-[#00B7B3]/30 flex items-center gap-2">
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        value={content.introduction.title}
                                        onChange={(e) => setContent(prev => ({ ...prev, introduction: { ...prev.introduction, title: e.target.value } }))}
                                        className="w-full px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                        placeholder="I am Naveen Bhagat"
                                    />
                                </div>
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        value={content.introduction.badgeText}
                                        onChange={(e) => setContent(prev => ({ ...prev, introduction: { ...prev.introduction, badgeText: e.target.value } }))}
                                        className="w-full px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                        placeholder="🕉️"
                                    />
                                </div>
                                <div>
                                    <label className="block text-sm text-gray-400 mb-2">Introduction Content</label>
                                    <RichTextEditor
                                        value={content.introduction.content}
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-4">
                                        <input
                                            type="text"
                                            value={content.introduction.image}
                                            onChange={(e) => setContent(prev => ({ ...prev, introduction: { ...prev.introduction, image: e.target.value } }))}
                                            className="flex-1 px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                            placeholder="https://example.com/image.jpg"
                                        />
                                        <label className="px-4 py-2 bg-[#00B7B3]/20 text-[#00B7B3] rounded-lg cursor-pointer hover:bg-[#00B7B3]/30 flex items-center gap-2">
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        value={content.teaching.title}
                                        onChange={(e) => setContent(prev => ({ ...prev, teaching: { ...prev.teaching, title: e.target.value } }))}
                                        className="w-full px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                        placeholder="Teaching Philosophy"
                                    />
                                </div>
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        value={content.teaching.badgeText}
                                        onChange={(e) => setContent(prev => ({ ...prev, teaching: { ...prev.teaching, badgeText: e.target.value } }))}
                                        className="w-full px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                        placeholder="Teaching"
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-4">
                                        <input
                                            type="text"
                                            value={content.teaching.image}
                                            onChange={(e) => setContent(prev => ({ ...prev, teaching: { ...prev.teaching, image: e.target.value } }))}
                                            className="flex-1 px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                            placeholder="https://example.com/image.jpg"
                                        />
                                        <label className="px-4 py-2 bg-[#00B7B3]/20 text-[#00B7B3] rounded-lg cursor-pointer hover:bg-[#00B7B3]/30 flex items-center gap-2">
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        value={content.consultation.title}
                                        onChange={(e) => setContent(prev => ({ ...prev, consultation: { ...prev.consultation, title: e.target.value } }))}
                                        className="w-full px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                        placeholder="Consultation Approach"
                                    />
                                </div>
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        value={content.consultation.badgeText}
                                        onChange={(e) => setContent(prev => ({ ...prev, consultation: { ...prev.consultation, badgeText: e.target.value } }))}
                                        className="w-full px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                        placeholder="Consultation"
                                    />
                                </div>
                                <div>
                                    ...
                                    <textarea
                                        rows="3"
                                        value={content.consultation.quote}
                                        onChange={(e) => setContent(prev => ({ ...prev, consultation: { ...prev.consultation, quote: e.target.value } }))}
                                        className="w-full px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                        placeholder="I do not view astrology as a tool for fortune telling..."
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-4">
                                        <input
                                            type="text"
                                            value={content.consultation.image}
                                            onChange={(e) => setContent(prev => ({ ...prev, consultation: { ...prev.consultation, image: e.target.value } }))}
                                            className="flex-1 px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                            placeholder="https://example.com/image.jpg"
                                        />
                                        <label className="px-4 py-2 bg-[#00B7B3]/20 text-[#00B7B3] rounded-lg cursor-pointer hover:bg-[#00B7B3]/30 flex items-center gap-2">
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        value={content.expertise.title}
                                        onChange={(e) => setContent(prev => ({ ...prev, expertise: { ...prev.expertise, title: e.target.value } }))}
                                        className="w-full px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                        placeholder="Areas of Expertise"
                                    />
                                </div>
                                <div>
                                    ...
                                    <textarea
                                        rows="2"
                                        value={content.expertise.description}
                                        onChange={(e) => setContent(prev => ({ ...prev, expertise: { ...prev.expertise, description: e.target.value } }))}
                                        className="w-full px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                        placeholder="Description..."
                                    />
                                </div>
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    setContent(prev => {
                                                        ...
                                                        return {
                                                            ...prev,
                                                            expertise: { ...prev.expertise, items: newItems }
                                                        };
                                                    });
                                                }}
                                                className="w-full px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        rows="2"
                                        value={content.expertise.footerText}
                                        onChange={(e) => setContent(prev => ({ ...prev, expertise: { ...prev.expertise, footerText: e.target.value } }))}
                                        className="w-full px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                        placeholder="My work emphasizes accuracy, practicality, and real-world outcomes..."
                                    />
                                </div>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        value={content.beyond.title}
                                        onChange={(e) => setContent(prev => ({ ...prev, beyond: { ...prev.beyond, title: e.target.value } }))}
                                        className="w-full px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                        placeholder="Beyond Astrology"
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-4">
                                        <input
                                            type="text"
                                            value={content.beyond.image}
                                            onChange={(e) => setContent(prev => ({ ...prev, beyond: { ...prev.beyond, image: e.target.value } }))}
                                            className="flex-1 px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                            placeholder="https://example.com/image.jpg"
                                        />
                                        <label className="px-4 py-2 bg-[#00B7B3]/20 text-[#00B7B3] rounded-lg cursor-pointer hover:bg-[#00B7B3]/30 flex items-center gap-2">
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        value={content.location.title}
                                        onChange={(e) => setContent(prev => ({ ...prev, location: { ...prev.location, title: e.target.value } }))}
                                        className="w-full px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                        placeholder="Current Location"
                                    />
                                </div>
                                <div>
                                    ...
                                    <textarea
                                        rows="3"
                                        value={content.location.description}
                                        onChange={(e) => setContent(prev => ({ ...prev, location: { ...prev.location, description: e.target.value } }))}
                                        className="w-full px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                        placeholder="Currently based in Greater Noida..."
                                    />
                                </div>
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        value={content.location.placeName}
                                        onChange={(e) => setContent(prev => ({ ...prev, location: { ...prev.location, placeName: e.target.value } }))}
                                        className="w-full px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                        placeholder="Greater Noida"
                                    />
                                </div>
                                <div>
                                    ...
                                    <div className="flex gap-4">
                                        <input
                                            type="text"
                                            value={content.location.image}
                                            onChange={(e) => setContent(prev => ({ ...prev, location: { ...prev.location, image: e.target.value } }))}
                                            className="flex-1 px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                            placeholder="https://example.com/image.jpg"
                                        />
                                        <label className="px-4 py-2 bg-[#00B7B3]/20 text-[#00B7B3] rounded-lg cursor-pointer hover:bg-[#00B7B3]/30 flex items-center gap-2">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        value={content.cta.buttonOneText}
                                        onChange={(e) => setContent(prev => ({ ...prev, cta: { ...prev.cta, buttonOneText: e.target.value } }))}
                                        className="w-full px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                        placeholder="Book Consultation"
                                    />
                                </div>
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        value={content.cta.buttonOneLink}
                                        onChange={(e) => setContent(prev => ({ ...prev, cta: { ...prev.cta, buttonOneLink: e.target.value } }))}
                                        className="w-full px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                        placeholder="/astrology-consultation"
                                    />
                                </div>
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        value={content.cta.buttonTwoText}
                                        onChange={(e) => setContent(prev => ({ ...prev, cta: { ...prev.cta, buttonTwoText: e.target.value } }))}
                                        className="w-full px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                        placeholder="Explore Courses"
                                    />
                                </div>
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        value={content.cta.buttonTwoLink}
                                        onChange={(e) => setContent(prev => ({ ...prev, cta: { ...prev.cta, buttonTwoLink: e.target.value } }))}
                                        className="w-full px-4 py-2 bg-black/60 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] outline-none"
                                        placeholder="/astrology-courses"
                                    />
                                </div>
