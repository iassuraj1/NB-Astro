...
//     // ✅ Get pageType from URL path - most reliable method
//     let pageType = paramPageType;
//     if (!pageType || pageType === 'undefined') {
//         const pathParts = location.pathname.split('/');
//         // Get last part of URL: /admin/page-content/astrology -> 'astrology'
//         pageType = pathParts[pathParts.length - 1];
//         console.log('📍 Extracted pageType from URL path:', pageType);
//     }
    
//     console.log('📍 Final pageType:', pageType);
...
//             fetchContent();
//         } else {
//             console.log('⚠️ Invalid or missing pageType:', pageType);
//             setLoading(false);
//         }
//     }, [pageType]);
...
//         setLoading(true);
//         try {
//             console.log('🔍 Fetching content for:', pageType);
//             console.log('🔍 API call: /page-content/' + pageType.toUpperCase());
...
//                 console.log('✅ Data received - Hero Title:', pageData.heroTitle);
...
//                 });
//             } else {
//                 console.log('No data found, will create new');
...
//         setSaving(true);
//         try {
//             console.log('💾 Saving for:', pageType);
//             const response = await pageContentAPI.save(pageType, content);
...
// // ✅ Quill Editor Styles with proper colors
// const quillStyles = `
//   .dark-quill {
//     background: #000000;
//     border-radius: 12px;
...
//   /* ✅ Bold text color - Teal like your theme */
//   .dark-quill .ql-editor strong {
//     color: #00B7B3 !important;
//     font-weight: bold !important;
//   }
  
//   /* Text colors - will work with color picker */
//   .dark-quill .ql-editor span[style*="color"] {
//     color: inherit;
//   }
...
// const colorPalette = [
//     '#000000', '#FFFFFF', '#00B7B3', '#33C5C2', '#66D9D6', '#99E5E2',
//     '#FF0000', '#FF5733', '#FFFF00', '#00FF00', '#0000FF', '#800080',
//     '#FF69B4', '#FFA500', '#808080', '#A52A2A', '#008000', '#FFC0CB',
//     '#00FFFF', '#FF4500', '#2E8B57', '#DC143C', '#8B4513', '#4B0082'
// ];
