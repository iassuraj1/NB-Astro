...
//     // ✅ STABLE handler for TinyMCE editor - FIXED
//     const handleFullDescriptionChange = useCallback((value) => {
//         setFormData(prev => ({
//             ...prev,
...
//     // ✅ Upload to server with auto-delete
...
//     formData.append('field', 'consultation');
...
//     // ✅ NEW: Submit with image delete support
...
//     uploadFormData.append('field', 'consultation');
//     uploadFormData.append('folder', 'consultations');
...
//                                 <div>
//                                     <label className="block text-gray-300 mb-1 text-sm font-medium">Title *</label>
//                                     <input type="text" value={formData.title} onChange={(e) => setFormData(prev => ({...prev, title: e.target.value}))} required className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] focus:outline-none" />
//                                 </div>
...
//                                     </div>
//                                     {useManualSlug ? (
//                                         <input type="text" value={formData.slug} onChange={(e) => setFormData(prev => ({...prev, slug: e.target.value.toLowerCase().replace(/[^a-z0-9-]/g, '-')}))} className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3] focus:outline-none" placeholder="enter-custom-slug" />
//                                     ) : (
//                                         <input type="text" value={generatedSlug} readOnly className="w-full px-3 py-2 bg-gray-800/50 border border-gray-700 rounded-lg text-gray-400" />
//                                     )}
//                                 </div>
...
//                                     <div>
//                                         <label className="block text-gray-300 mb-1 text-sm font-medium">Price (Display) *</label>
//                                         <input type="text" value={formData.price} onChange={(e) => setFormData(prev => ({...prev, price: e.target.value}))} required className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3]" placeholder="₹25,000" />
//                                     </div>
//                                     <div>
//                                         <label className="block text-gray-300 mb-1 text-sm font-medium">Price (Numeric) *</label>
//                                         <input type="number" value={formData.priceNumeric} onChange={(e) => setFormData(prev => ({...prev, priceNumeric: parseInt(e.target.value) || 0}))} required className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3]" />
//                                     </div>
//                                 </div>
...
//                                     <div>
//                                         <label className="block text-gray-300 mb-1 text-sm font-medium">Icon (Emoji)</label>
//                                         <input type="text" value={formData.icon} onChange={(e) => setFormData(prev => ({...prev, icon: e.target.value}))} className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3]" placeholder="🔮" />
//                                     </div>
//                                     <div>
//                                         <label className="block text-gray-300 mb-1 text-sm font-medium">Duration</label>
//                                         <input type="text" value={formData.duration} onChange={(e) => setFormData(prev => ({...prev, duration: e.target.value}))} className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3]" placeholder="60 mins" />
//                                     </div>
//                                 </div>

//                                 <div>
//                                     <label className="block text-gray-300 mb-1 text-sm font-medium">Expert</label>
//                                     <input type="text" value={formData.expert} onChange={(e) => setFormData(prev => ({...prev, expert: e.target.value}))} className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3]" />
//                                 </div>

//                                 <div>
//                                     <label className="block text-gray-300 mb-1 text-sm font-medium">Quick Description (SEO Meta) *</label>
//                                     <textarea value={formData.quickDescription} onChange={(e) => setFormData(prev => ({...prev, quickDescription: e.target.value}))} required maxLength="160" rows="2" className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3]" />
//                                     <div className="text-right text-xs text-gray-500 mt-1">{formData.quickDescription.length}/160</div>
//                                 </div>
...
//                                 <div>
//                                     <label className="block text-gray-300 mb-1 text-sm font-medium">Short Description *</label>
//                                     <textarea value={formData.shortDescription} onChange={(e) => setFormData(prev => ({...prev, shortDescription: e.target.value}))} required rows="3" className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3]" />
//                                 </div>

//                                 <div>
//                                     <label className="block text-gray-300 mb-1 text-sm font-medium">Long Description *</label>
//                                     <textarea value={formData.longDescription} onChange={(e) => setFormData(prev => ({...prev, longDescription: e.target.value}))} required rows="5" className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3]" />
//                                 </div>

//                                 <div>
//                                     <label className="block text-gray-300 mb-2 text-sm font-medium">Full Description (Rich Text) *</label>
//                                     {/* ✅ FIXED: Stable onChange handler - BLINK FREE */}
//                                     <TinyMCEEditor
//                                         value={formData.fullDescription} 
...
//                                 <div>
//                                     <label className="block text-gray-300 mb-1 text-sm font-medium">SEO Description</label>
//                                     <textarea value={formData.seoDescription} onChange={(e) => setFormData(prev => ({...prev, seoDescription: e.target.value}))} rows="2" className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3]" />
//                                     <p className="text-gray-500 text-xs mt-1">Recommended: 150-160 characters. Appears in search results.</p>
//                                 </div>

//                                 <div>
//                                     <label className="block text-gray-300 mb-1 text-sm font-medium">SEO Keywords</label>
//                                     <input type="text" value={formData.seoKeywords} onChange={(e) => setFormData(prev => ({...prev, seoKeywords: e.target.value}))} className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:border-[#00B7B3]" placeholder="keyword1, keyword2, keyword3" />
//                                     <p className="text-gray-500 text-xs mt-1">Comma separated keywords for search engines.</p>
//                                 </div>
//                             </div>
//                         )}
...
const ConsultationManager = ({ category = 'astrology' }) => {
    ...
    // ✅ STABLE handler for TinyMCE editor
    const handleFullDescriptionChange = useCallback((value) => {
        setFormData(prev => ({
            ...prev,
            fullDescription: value
...
const handleImageChange = async (e) => {
    ...
    // ✅ Get old image path from formData
    const oldImagePath = formData.image || '';
    console.log('🔍 Old image path from formData:', oldImagePath);
...
const handleSubmit = async (e) => {
    ...
    try {
        // ✅ If new image is selected, upload it first with delete
        ...
        if (imageFile) {
            ...
            // ✅ IMPORTANT: Send OLD image path from formData
            const oldImagePath = formData.image || '';
            if (oldImagePath) {
                uploadFormData.append('oldImagePath', oldImagePath);
                console.log('🗑️ Sending old image for deletion:', oldImagePath);
            ...
            const token = localStorage.getItem('adminToken');
            const uploadResponse = await fetch('/api/upload/with-delete', {
                method: 'POST',
                headers: { 'Authorization': `Bearer ${token}` },
                body: uploadFormData
            });
            ...
            if (uploadData.success) {
                ...
                if (uploadData.oldImageDeleted) {
                    console.log('✅ Old image deleted from server');
                }
            } else {
                alert('❌ Failed to upload image: ' + (uploadData.message || 'Unknown error'));
                setLoading(false);
                return;
            }
        }
        
        // ✅ Submit form data with NEW image path
        const submitData = new FormData();
        Object.keys(formData).forEach(key => {
            if (Array.isArray(formData[key])) {
                submitData.append(key, JSON.stringify(formData[key]));
        ...
        // ✅ Add NEW image path
        submitData.append('image', imagePath);
...
const handleEdit = (service) => {
    ...
    setFormData({
        ...
        isActive: service.isActive !== undefined ? service.isActive : true,
        isFeatured: service.isFeatured || false,
        // ✅ IMPORTANT: Store image path for deletion
        image: service.image || ''
    });
