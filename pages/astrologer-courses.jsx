...
export default function AstrologerCoursesRoute({ seo, pageContent }) {
  return <PublicLayout><SeoHead seo={seo} /><AstrologyCoursesPage initialPageContent={pageContent} /></PublicLayout>;
}

export const getServerSideProps = async () => {
  const { seo, content } = await getPageContentSeo('ASTROLOGY', {
    ...pageSeo.astrologyCourses,
    path: '/astrologer-courses',
  });
